      ...
      <div style={{ flex: 1, padding: '2rem', maxWidth: 1400, width: '100%', margin: '0 auto', boxSizing: 'border-box' }}>
        ...
        {!loading && !error && !uiConfig && !credExpired && (
          <div style={{
            ...
            <div>
              <h2 style={{ fontSize: '1.35rem', fontWeight: 700, letterSpacing: '-0.4px', color: 'var(--text)' }}>
                Dashboard IA
              </h2>
              <p style={{ fontSize: '0.9rem', color: 'var(--text-tertiary)', marginTop: '0.4rem', maxWidth: 380 }}>
                Describe en español qué quieres visualizar y Bedrock generará el dashboard automáticamente.
              </p>
            </div>
        ...
        {uiConfig && !loading && (
          <div key={resultKey} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{
              ...
              <div>
                <h2 style={{
                  fontSize: '1.4rem', fontWeight: 700, letterSpacing: '-0.4px',
              ...
              <button
                onClick={() => { setUiConfig(null); setIntent(''); inputRef.current?.focus(); }}
                style={{
                  background: 'var(--surface)',
                  border: '1px solid var(--border-color)',
                  borderRadius: 'var(--radius-sm)',
